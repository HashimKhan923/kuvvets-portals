    ...
    public function run(): void
    {
        ...
        if ($company) {
            $leaveTypes = [
                ...
                ['name'=>'Sick Leave',      'code'=>'SL',  'days_per_year'=>8,  'is_paid'=>true,  'requires_document'=>true,  'color'=>'#CBA557'],
                ...
                ['name'=>'Eid Leave',       'code'=>'EID', 'days_per_year'=>3,  'is_paid'=>true,  'color'=>'#CBA557'],
