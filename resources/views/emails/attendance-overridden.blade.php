<x-emails.layout>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr><td style="text-align:center;padding:4px 0 8px;">
            <a href="{{ url('/employee/attendance') }}" style="display:inline-block;background-color:#0F0901;color:#D4A843;text-decoration:none;padding:14px 36px;border-radius:12px;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">View Attendance History &rarr;</a>
        </td></tr>
    </table>
