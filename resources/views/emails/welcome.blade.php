<x-emails.layout>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#0F0901;border-radius:12px;margin-bottom:24px;">
        <tr>
            <td style="padding:20px 24px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td style="font-family:'Courier New',monospace;font-size:13px;color:#D4A843;font-weight:700;padding:6px 0;border-bottom:1px solid rgba(255,255,255,0.08);text-align:right;">{{ url('/employee/login') }}</td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-family:'Courier New',monospace;font-size:13px;color:#D4A843;font-weight:700;padding:6px 0;border-bottom:1px solid rgba(255,255,255,0.08);text-align:right;">{{ $username }}</td>
                    </tr>
                    <tr>
                        <td style="font-family:'Courier New',monospace;font-size:13px;color:rgba(255,255,255,0.55);padding:6px 0;">Temp. Password</td>
                        <td style="font-family:'Courier New',monospace;font-size:13px;color:#D4A843;font-weight:700;padding:6px 0;text-align:right;">{{ $password }}</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td style="text-align:center;padding:4px 0 8px;">
                <a href="{{ url('/employee/login') }}" style="display:inline-block;background-color:#0F0901;color:#D4A843;text-decoration:none;padding:14px 36px;border-radius:12px;font-family:Arial,sans-serif;font-size:14px;font-weight:700;letter-spacing:0.3px;">Login Now &rarr;</a>
            </td>
        </tr>
    </table>
