<x-emails.layout>
        ...
        <tr><td style="background-color:#F7F3EF;padding:0 18px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td style="font-family:'Courier New',monospace;font-size:13px;color:#D4A843;font-weight:600;padding:12px 0;border-bottom:1px solid #F0EAE2;">{{ $payslip->payslip_number }}</td>
                </tr>
                <tr>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr><td style="text-align:center;padding:4px 0 8px;">
            <a href="{{ url('/employee/payslips') }}" style="display:inline-block;background-color:#0F0901;color:#D4A843;text-decoration:none;padding:14px 36px;border-radius:12px;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">View &amp; Download Payslip &rarr;</a>
        </td></tr>
    </table>
